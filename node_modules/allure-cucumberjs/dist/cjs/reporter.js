...
class AllureCucumberReporter extends _cucumber.Formatter {
  ...
  onTestCaseStarted(data) {
    ...
    var testCaseId = (0, _reporter.md5)("".concat(fullNameBase, "#").concat((_scenario$name = scenario === null || scenario === void 0 ? void 0 : scenario.name) !== null && _scenario$name !== void 0 ? _scenario$name : pickle.name));
    var legacyTestCaseId = (0, _reporter.md5)("".concat(posixPath, "#").concat((_scenario$name2 = scenario === null || scenario === void 0 ? void 0 : scenario.name) !== null && _scenario$name2 !== void 0 ? _scenario$name2 : pickle.name));
    var result = {
      name: pickle.name,
    ...
    result.labels.push((0, _reporter.getLanguageLabel)(), (0, _reporter.getFrameworkLabel)("cucumberjs"), (0, _reporter.getPackageLabel)((0, _utils.getPathRelativeToProjectRoot)(pickle)), (0, _reporter.getFallbackTestCaseIdLabel)(legacyTestCaseId), (0, _reporter.getHostLabel)(), (0, _reporter.getThreadLabel)(data.workerId));
  ...
  onAttachment(message) {
    ...
    if (message.mediaType === _reporter.ALLURE_RUNTIME_MESSAGE_CONTENT_TYPE) {
      if (fixtureUuid && testUuid) {
        ...
        var hasPlaywrightTrace = runtimeMessages.some(msg => (msg.type === "attachment_content" || msg.type === "attachment_path") && msg.data.contentType === _allureJsCommons.ContentType.PLAYWRIGHT_TRACE);
